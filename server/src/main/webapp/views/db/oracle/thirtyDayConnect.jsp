...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#sevenday_grid").Grid({
                url:ctx + "/db/oracle/sta/viewTable/"+monitorId+"/1/1/2",
                dataType:"json",
                height:'auto',
                colums:[
        ...
        function getSevenDayGraph() {
            var _data ;
            $.ajax({
                url:ctx+"/db/oracle/sta/viewGrid/"+monitorId+"/1/1/2",
                dataType:"json",
                cache:false,
                async:false,
...
<div id="layout_center">
    <div class="main" style="padding-bottom:60px;" id="main">
        <div class="threshold_file">
            <div class="sub_title">最近30天的连接时间</div>
