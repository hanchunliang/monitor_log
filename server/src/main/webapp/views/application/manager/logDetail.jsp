...
<head>
    ...
    <title>monitor监控系统-事件日志透视</title>
...
<style type="text/css">
    .csxx{ position: static;}
    .grid_box{position: static;}
    .grid_box .grid_head{ position: static;}
    .grid_head .gird_head_column{position: static;}
    .grid_view{position:static;}
</style>
</head>
...
<div id="layout_center">
    <div class="log_detail">
        ...
        <div class="csxx" style="width:49%;float:left; margin-left:5px;">
            <div class="threshold_file">
