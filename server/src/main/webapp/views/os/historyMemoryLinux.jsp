...
$(function(){
	creatSimpleChart(url, 'last_sevenday', '值%');
})
function navHover(){
				...
				<div class="threshold_file">
					...
					<table class="base_info" width="100%" cellpadding="0"
						...
						<tr>
							<td colspan="2">
								<div class="days_data">
									<a href="historyMemoryThirtyDay.jsp"><div class="thirty_days"></div> </a>
									<a href="historyMemorySevenDay.jsp"><div class="seven_days"></div> </a>
								</div>
							</td>
						</tr>
						<tr>
