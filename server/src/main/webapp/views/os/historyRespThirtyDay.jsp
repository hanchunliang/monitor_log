...
$(function(){
	var id= $("#osid").val();
	creatSimpleChart('${ctx}/os/historyRepStatiLine/30/'+id, 'last_sevenday', '响应时间 毫秒');
	$("body").layout({
		top:{topHeight:100},
	...
	$("#sevenday_grid").Grid({
		type : "POST",
		url : "${ctx}/os/historyRepStatiGrid/30/"+id,
		dataType: "json",
		height: 'auto',
		colums:[
			{id:'1',text:'日期',name:"methodName",width:'',index:'1',align:'',color:''},
			{id:'2',text:'最小值',name:"maxTime",width:'300',index:'1',align:'',color:''},
			{id:'3',text:'最大值  ',name:"minTime",width:'',index:'1',align:'',color:''},
			{id:'4',text:'平均值',name:"avgTime",width:'',index:'1',align:'',color:''},
		],
		rowNum:99,
		rowList:[10,20,30],
		pager : false,
          ...
          <table class="base_info" width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr><td colspan="2"> 
            	<div class="days_data">
                  ...
                  <a  href="${ctx }/os/historyRespond/7/${os.osInfoId}"><div class="seven_days"></div></a>
                </div></td></tr>
