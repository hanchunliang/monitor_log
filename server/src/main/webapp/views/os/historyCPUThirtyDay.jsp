...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		$(function(){
			var id= $("#osid").val();
			creatSimpleChart('${ctx}/os/historyCPUStatiLine/30/'+id, 'last_Thirtyday', 'CPU用户利用率%');
						...
						<tr>
							<td colspan="2">
								<div class="days_data">
									...
									<a href="${ctx}/os/historyCPU/7/${os.osInfoId }"><div class="seven_days"></div>
									</a>
								</div>
							</td>
						</tr>
